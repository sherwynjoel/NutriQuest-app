@echo off
echo ========================================
echo    NutriQuest Demo Server - FIXED
echo ========================================
echo.
...
if not exist "nutriquest_quiz.html" (
    echo ERROR: nutriquest_quiz.html not found!
    echo Please make sure you're running this from the NutriQuest directory.
    pause
    exit /b 1
)
...
echo Opening NutriQuest in your browser...
...
echo    - Quiz Game: http://localhost:3000/nutriquest_quiz.html
echo    - Games Hub: http://localhost:3000/games_hub.html
